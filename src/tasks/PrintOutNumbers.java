...
public class PrintOutNumbers {
    public static void main(String[] args) {
        ...
        //Hints: 2 different operations - up or down from O, put together.
        // for loop - because we know how many times need to run after input already
        // 2 else combination and 2 loops
